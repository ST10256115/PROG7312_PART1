...
## Install in Visual Studio:
 ...
 - or Package Manager Console: Install-Package Newtonsoft.Json


## How to Build & Run
 - Open the solution in Visual Studio.
   
 - Target Framework: set to .NET Framework 4.7.2 or 4.8
 
 - Project → Properties → Application → Target framework

 - Dependencies: confirm Newtonsoft.Json is installed (see prerequisites).
